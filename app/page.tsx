...
export default async function Home(){
 ...
 return <main>
  ...
  <section className="hero"><div className="container hero-grid">
   <div className="card hero-copy"><span className="eyebrow">Augusta • CSRA • Mobile Booking</span><h1>Rent the right trailer or equipment. Get the job done.</h1><p>From trailers to generators and power equipment, get what you need without buying it for one job. Trailer availability and booking are online, with more equipment being added now.</p>
    <div className="actions"><Link className="btn" href="#rentals">View Rentals</Link><a className="btn2" href="tel:7066996990">Call 706-699-6990</a></div>
    <div className="stats"><div className="stat"><b>2+</b><small>Rental Categories</small></div><div className="stat"><b>24/7</b><small>Requests</small></div><div className="stat"><b>Local</b><small>CSRA Rentals</small></div></div>
   </div>
  ...
  <section id="rentals"><div className="container"><div className="section-head"><span className="eyebrow">Choose your rental</span><h2>Trailers & equipment</h2><p className="muted">Rent what you need for hauling, projects, backup power and more.</p></div><div className="grid three"><article className="trailer"><div className="trailer-body"><span className="eyebrow">Hauling</span><h3>Trailer Rentals</h3><p className="muted">Car haulers and dump trailers with online availability and rental requests.</p><Link className="btn" href="#trailers">View Trailers</Link></div></article><article className="trailer"><div className="trailer-body"><span className="eyebrow">Power</span><h3>Generator Rentals</h3><p className="muted">Portable generators for jobs, events, outages and temporary power needs.</p><Link className="btn" href="/equipment#generators">View Generators</Link></div></article><article className="trailer"><div className="trailer-body"><span className="eyebrow">Tools</span><h3>Power Tools & Equipment</h3><p className="muted">Outdoor power equipment and specialty tools, including augers, with more inventory coming.</p><Link className="btn" href="/equipment#tools">View Equipment</Link></div></article></div></div></section>
  ...
  <section id="faq"><div className="container"><div className="section-head"><span className="eyebrow">Common questions</span><h2>Rental FAQ</h2></div>
